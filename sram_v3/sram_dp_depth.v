...
//       
//       Creation Date:  Sun May 21 10:30:33 2023
//       Version: 	r5p0
//
...
`ifdef POWER_PINS
module sram_dp_depth (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB,
...
`else
module sram_dp_depth (CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB, QA, QB, CLKA,
...
`endif
  ...
  reg LAST_CLKB;
  reg [15:0] QA_int;
  reg [15:0] QA_int_delayed;
  reg [15:0] QB_int;
  reg [15:0] QB_int_delayed;
 ...
 wire  CLKB_;
  ...
  assign `ARM_UD_DP DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {16{1'bx}};
  ...
  assign `ARM_UD_DP DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {16{1'bx}};
  assign `ARM_UD_SEQ QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {16{1'bx}};
  assign `ARM_UD_SEQ QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {16{1'bx}};
	...
	$readmemb(filename, memld);
     if (CENA_ === 1'b1 && CENB_ === 1'b1) begin
      ...
      row = mem[row_address];
        ...
        new_data =  ( {15'b000000000000000, wordtemp[15], 15'b000000000000000, wordtemp[14],
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENA_int)} === 1'bx) begin
      ...
      QA_int_delayed = WENA_int !== 1'b1 ? QA_int_delayed : {16{1'bx}};
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENB_int)} === 1'bx) begin
      ...
      QB_int_delayed = WENB_int !== 1'b1 ? QB_int_delayed : {16{1'bx}};
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B27(CENYB, CENYB_);
  buf B28(WENYB, WENYB_);
  buf B29(AYB[0], AYB_[0]);
  buf B30(AYB[1], AYB_[1]);
  buf B31(AYB[2], AYB_[2]);
  buf B32(AYB[3], AYB_[3]);
  buf B33(AYB[4], AYB_[4]);
  buf B34(AYB[5], AYB_[5]);
  buf B35(AYB[6], AYB_[6]);
  buf B36(AYB[7], AYB_[7]);
  buf B37(AYB[8], AYB_[8]);
  buf B38(DYB[0], DYB_[0]);
  buf B39(DYB[1], DYB_[1]);
  buf B40(DYB[2], DYB_[2]);
  buf B41(DYB[3], DYB_[3]);
  buf B42(DYB[4], DYB_[4]);
  buf B43(DYB[5], DYB_[5]);
  buf B44(DYB[6], DYB_[6]);
  buf B45(DYB[7], DYB_[7]);
  buf B46(DYB[8], DYB_[8]);
  buf B47(DYB[9], DYB_[9]);
  buf B48(DYB[10], DYB_[10]);
  buf B49(DYB[11], DYB_[11]);
  buf B50(DYB[12], DYB_[12]);
  buf B51(DYB[13], DYB_[13]);
  buf B52(DYB[14], DYB_[14]);
  buf B53(DYB[15], DYB_[15]);
  buf B54(QA[0], QA_[0]);
  buf B55(QA[1], QA_[1]);
  buf B56(QA[2], QA_[2]);
  buf B57(QA[3], QA_[3]);
  ...
  buf B62(QA[8], QA_[8]);
  buf B63(QA[9], QA_[9]);
  buf B64(QA[10], QA_[10]);
  buf B65(QA[11], QA_[11]);
  buf B66(QA[12], QA_[12]);
  buf B67(QA[13], QA_[13]);
  buf B68(QA[14], QA_[14]);
  buf B69(QA[15], QA_[15]);
  buf B70(QB[0], QB_[0]);
  buf B71(QB[1], QB_[1]);
  buf B72(QB[2], QB_[2]);
  buf B73(QB[3], QB_[3]);
  ...
  buf B78(QB[8], QB_[8]);
  buf B79(QB[9], QB_[9]);
  buf B80(QB[10], QB_[10]);
  buf B81(QB[11], QB_[11]);
  buf B82(QB[12], QB_[12]);
  buf B83(QB[13], QB_[13]);
  buf B84(QB[14], QB_[14]);
  buf B85(QB[15], QB_[15]);
  buf B86(CLKA_, CLKA);
  buf B87(CENA_, CENA);
  buf B88(WENA_, WENA);
  buf B89(AA_[0], AA[0]);
  ...
  buf B106(DA_[8], DA[8]);
  buf B107(DA_[9], DA[9]);
  buf B108(DA_[10], DA[10]);
  buf B109(DA_[11], DA[11]);
  buf B110(DA_[12], DA[12]);
  buf B111(DA_[13], DA[13]);
  buf B112(DA_[14], DA[14]);
  buf B113(DA_[15], DA[15]);
  buf B114(CLKB_, CLKB);
  buf B115(CENB_, CENB);
  buf B116(WENB_, WENB);
  buf B117(AB_[0], AB[0]);
  ...
  buf B134(DB_[8], DB[8]);
  buf B135(DB_[9], DB[9]);
  buf B136(DB_[10], DB[10]);
  buf B137(DB_[11], DB[11]);
  buf B138(DB_[12], DB[12]);
  buf B139(DB_[13], DB[13]);
  buf B140(DB_[14], DB[14]);
  buf B141(DB_[15], DB[15]);
  buf B142(EMAA_[0], EMAA[0]);
  buf B143(EMAA_[1], EMAA[1]);
  buf B144(EMAA_[2], EMAA[2]);
  buf B145(EMAWA_[0], EMAWA[0]);
  buf B146(EMAWA_[1], EMAWA[1]);
  buf B147(EMASA_, EMASA);
  buf B148(EMAB_[0], EMAB[0]);
  buf B149(EMAB_[1], EMAB[1]);
  buf B150(EMAB_[2], EMAB[2]);
  buf B151(EMAWB_[0], EMAWB[0]);
  buf B152(EMAWB_[1], EMAWB[1]);
  buf B153(EMASB_, EMASB);
  buf B154(TENA_, TENA);
  buf B155(BENA_, BENA);
  buf B156(TCENA_, TCENA);
  buf B157(TWENA_, TWENA);
  buf B158(TAA_[0], TAA[0]);
  buf B159(TAA_[1], TAA[1]);
  buf B160(TAA_[2], TAA[2]);
  buf B161(TAA_[3], TAA[3]);
  buf B162(TAA_[4], TAA[4]);
  buf B163(TAA_[5], TAA[5]);
  buf B164(TAA_[6], TAA[6]);
  buf B165(TAA_[7], TAA[7]);
  buf B166(TAA_[8], TAA[8]);
  buf B167(TDA_[0], TDA[0]);
  buf B168(TDA_[1], TDA[1]);
  buf B169(TDA_[2], TDA[2]);
  buf B170(TDA_[3], TDA[3]);
  buf B171(TDA_[4], TDA[4]);
  buf B172(TDA_[5], TDA[5]);
  buf B173(TDA_[6], TDA[6]);
  buf B174(TDA_[7], TDA[7]);
  buf B175(TDA_[8], TDA[8]);
  buf B176(TDA_[9], TDA[9]);
  buf B177(TDA_[10], TDA[10]);
  buf B178(TDA_[11], TDA[11]);
  buf B179(TDA_[12], TDA[12]);
  buf B180(TDA_[13], TDA[13]);
  buf B181(TDA_[14], TDA[14]);
  buf B182(TDA_[15], TDA[15]);
  buf B183(TQA_[0], TQA[0]);
  buf B184(TQA_[1], TQA[1]);
  buf B185(TQA_[2], TQA[2]);
  buf B186(TQA_[3], TQA[3]);
  buf B187(TQA_[4], TQA[4]);
  buf B188(TQA_[5], TQA[5]);
  buf B189(TQA_[6], TQA[6]);
  buf B190(TQA_[7], TQA[7]);
  buf B191(TQA_[8], TQA[8]);
  buf B192(TQA_[9], TQA[9]);
  buf B193(TQA_[10], TQA[10]);
  buf B194(TQA_[11], TQA[11]);
  buf B195(TQA_[12], TQA[12]);
  buf B196(TQA_[13], TQA[13]);
  buf B197(TQA_[14], TQA[14]);
  buf B198(TQA_[15], TQA[15]);
  buf B199(TENB_, TENB);
  buf B200(BENB_, BENB);
  buf B201(TCENB_, TCENB);
  buf B202(TWENB_, TWENB);
  buf B203(TAB_[0], TAB[0]);
  buf B204(TAB_[1], TAB[1]);
  buf B205(TAB_[2], TAB[2]);
  buf B206(TAB_[3], TAB[3]);
  buf B207(TAB_[4], TAB[4]);
  buf B208(TAB_[5], TAB[5]);
  buf B209(TAB_[6], TAB[6]);
  buf B210(TAB_[7], TAB[7]);
  buf B211(TAB_[8], TAB[8]);
  buf B212(TDB_[0], TDB[0]);
  buf B213(TDB_[1], TDB[1]);
  buf B214(TDB_[2], TDB[2]);
  buf B215(TDB_[3], TDB[3]);
  buf B216(TDB_[4], TDB[4]);
  buf B217(TDB_[5], TDB[5]);
  buf B218(TDB_[6], TDB[6]);
  buf B219(TDB_[7], TDB[7]);
  buf B220(TDB_[8], TDB[8]);
  buf B221(TDB_[9], TDB[9]);
  buf B222(TDB_[10], TDB[10]);
  buf B223(TDB_[11], TDB[11]);
  buf B224(TDB_[12], TDB[12]);
  buf B225(TDB_[13], TDB[13]);
  buf B226(TDB_[14], TDB[14]);
  buf B227(TDB_[15], TDB[15]);
  buf B228(TQB_[0], TQB[0]);
  buf B229(TQB_[1], TQB[1]);
  buf B230(TQB_[2], TQB[2]);
  buf B231(TQB_[3], TQB[3]);
  buf B232(TQB_[4], TQB[4]);
  buf B233(TQB_[5], TQB[5]);
  buf B234(TQB_[6], TQB[6]);
  buf B235(TQB_[7], TQB[7]);
  buf B236(TQB_[8], TQB[8]);
  buf B237(TQB_[9], TQB[9]);
  buf B238(TQB_[10], TQB[10]);
  buf B239(TQB_[11], TQB[11]);
  buf B240(TQB_[12], TQB[12]);
  buf B241(TQB_[13], TQB[13]);
  buf B242(TQB_[14], TQB[14]);
  buf B243(TQB_[15], TQB[15]);
  buf B244(RET1N_, RET1N);
  buf B245(STOVA_, STOVA);
  buf B246(STOVB_, STOVB);
  buf B247(COLLDISN_, COLLDISN);
  ...
  assign DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {16{1'bx}};
  ...
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {16{1'bx}};
   `ifdef ARM_FAULT_MODELING
     sram_dp_depth_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .WEN(WENA_int), .Q_in(QA_int));
  `else
  assign QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {16{1'bx}};
  `endif
  assign QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {16{1'bx}};
...
`endif
`timescale 1ns/1ps
module sram_dp_depth_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, BEN, TQ);
   output [15:0] Q_out;
   input [15:0] Q_in;
   input CLK;
   input [8:0] A;
