...
//       
//       Creation Date:  Sun May 21 10:29:32 2023
//       Version: 	r5p0
//
...
`ifdef POWER_PINS
module sram_dp_point (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB,
...
`else
module sram_dp_point (CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB, QA, QB, CLKA,
...
`endif
  ...
  reg NOT_AA1, NOT_AA0, NOT_DA19, NOT_DA18, NOT_DA17, NOT_DA16, NOT_DA15, NOT_DA14;
  ...
  reg NOT_AB6, NOT_AB5, NOT_AB4, NOT_AB3, NOT_AB2, NOT_AB1, NOT_AB0, NOT_DB19, NOT_DB18;
  ...
  reg NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TDA19, NOT_TDA18, NOT_TDA17, NOT_TDA16, NOT_TDA15;
  ...
  reg NOT_TCENB, NOT_TWENB, NOT_TAB8, NOT_TAB7, NOT_TAB6, NOT_TAB5, NOT_TAB4, NOT_TAB3;
  reg NOT_TAB2, NOT_TAB1, NOT_TAB0, NOT_TDB19, NOT_TDB18, NOT_TDB17, NOT_TDB16, NOT_TDB15;
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B31(CENYB, CENYB_);
  buf B32(WENYB, WENYB_);
  buf B33(AYB[0], AYB_[0]);
  buf B34(AYB[1], AYB_[1]);
  buf B35(AYB[2], AYB_[2]);
  buf B36(AYB[3], AYB_[3]);
  buf B37(AYB[4], AYB_[4]);
  buf B38(AYB[5], AYB_[5]);
  buf B39(AYB[6], AYB_[6]);
  buf B40(AYB[7], AYB_[7]);
  buf B41(AYB[8], AYB_[8]);
  buf B42(DYB[0], DYB_[0]);
  buf B43(DYB[1], DYB_[1]);
  buf B44(DYB[2], DYB_[2]);
  buf B45(DYB[3], DYB_[3]);
  buf B46(DYB[4], DYB_[4]);
  buf B47(DYB[5], DYB_[5]);
  buf B48(DYB[6], DYB_[6]);
  buf B49(DYB[7], DYB_[7]);
  buf B50(DYB[8], DYB_[8]);
  buf B51(DYB[9], DYB_[9]);
  buf B52(DYB[10], DYB_[10]);
  buf B53(DYB[11], DYB_[11]);
  buf B54(DYB[12], DYB_[12]);
  buf B55(DYB[13], DYB_[13]);
  buf B56(DYB[14], DYB_[14]);
  buf B57(DYB[15], DYB_[15]);
  buf B58(DYB[16], DYB_[16]);
  buf B59(DYB[17], DYB_[17]);
  buf B60(DYB[18], DYB_[18]);
  buf B61(DYB[19], DYB_[19]);
  buf B62(QA[0], QA_[0]);
  buf B63(QA[1], QA_[1]);
  buf B64(QA[2], QA_[2]);
  buf B65(QA[3], QA_[3]);
  ...
  buf B70(QA[8], QA_[8]);
  buf B71(QA[9], QA_[9]);
  buf B72(QA[10], QA_[10]);
  buf B73(QA[11], QA_[11]);
  buf B74(QA[12], QA_[12]);
  buf B75(QA[13], QA_[13]);
  buf B76(QA[14], QA_[14]);
  buf B77(QA[15], QA_[15]);
  buf B78(QA[16], QA_[16]);
  buf B79(QA[17], QA_[17]);
  buf B80(QA[18], QA_[18]);
  buf B81(QA[19], QA_[19]);
  buf B82(QB[0], QB_[0]);
  buf B83(QB[1], QB_[1]);
  buf B84(QB[2], QB_[2]);
  buf B85(QB[3], QB_[3]);
  ...
  buf B90(QB[8], QB_[8]);
  buf B91(QB[9], QB_[9]);
  buf B92(QB[10], QB_[10]);
  buf B93(QB[11], QB_[11]);
  buf B94(QB[12], QB_[12]);
  buf B95(QB[13], QB_[13]);
  buf B96(QB[14], QB_[14]);
  buf B97(QB[15], QB_[15]);
  buf B98(QB[16], QB_[16]);
  buf B99(QB[17], QB_[17]);
  buf B100(QB[18], QB_[18]);
  buf B101(QB[19], QB_[19]);
  buf B102(CLKA_, CLKA);
  buf B103(CENA_, CENA);
  buf B104(WENA_, WENA);
  buf B105(AA_[0], AA[0]);
  ...
  buf B122(DA_[8], DA[8]);
  buf B123(DA_[9], DA[9]);
  buf B124(DA_[10], DA[10]);
  buf B125(DA_[11], DA[11]);
  buf B126(DA_[12], DA[12]);
  buf B127(DA_[13], DA[13]);
  buf B128(DA_[14], DA[14]);
  buf B129(DA_[15], DA[15]);
  buf B130(DA_[16], DA[16]);
  buf B131(DA_[17], DA[17]);
  buf B132(DA_[18], DA[18]);
  buf B133(DA_[19], DA[19]);
  buf B134(CLKB_, CLKB);
  buf B135(CENB_, CENB);
  buf B136(WENB_, WENB);
  buf B137(AB_[0], AB[0]);
  ...
  buf B154(DB_[8], DB[8]);
  buf B155(DB_[9], DB[9]);
  buf B156(DB_[10], DB[10]);
  buf B157(DB_[11], DB[11]);
  buf B158(DB_[12], DB[12]);
  buf B159(DB_[13], DB[13]);
  buf B160(DB_[14], DB[14]);
  buf B161(DB_[15], DB[15]);
  buf B162(DB_[16], DB[16]);
  buf B163(DB_[17], DB[17]);
  buf B164(DB_[18], DB[18]);
  buf B165(DB_[19], DB[19]);
  buf B166(EMAA_[0], EMAA[0]);
  buf B167(EMAA_[1], EMAA[1]);
  buf B168(EMAA_[2], EMAA[2]);
  buf B169(EMAWA_[0], EMAWA[0]);
  buf B170(EMAWA_[1], EMAWA[1]);
  buf B171(EMASA_, EMASA);
  buf B172(EMAB_[0], EMAB[0]);
  buf B173(EMAB_[1], EMAB[1]);
  buf B174(EMAB_[2], EMAB[2]);
  buf B175(EMAWB_[0], EMAWB[0]);
  buf B176(EMAWB_[1], EMAWB[1]);
  buf B177(EMASB_, EMASB);
  buf B178(TENA_, TENA);
  buf B179(BENA_, BENA);
  buf B180(TCENA_, TCENA);
  buf B181(TWENA_, TWENA);
  buf B182(TAA_[0], TAA[0]);
  buf B183(TAA_[1], TAA[1]);
  buf B184(TAA_[2], TAA[2]);
  buf B185(TAA_[3], TAA[3]);
  buf B186(TAA_[4], TAA[4]);
  buf B187(TAA_[5], TAA[5]);
  buf B188(TAA_[6], TAA[6]);
  buf B189(TAA_[7], TAA[7]);
  buf B190(TAA_[8], TAA[8]);
  buf B191(TDA_[0], TDA[0]);
  buf B192(TDA_[1], TDA[1]);
  buf B193(TDA_[2], TDA[2]);
  buf B194(TDA_[3], TDA[3]);
  buf B195(TDA_[4], TDA[4]);
  buf B196(TDA_[5], TDA[5]);
  buf B197(TDA_[6], TDA[6]);
  buf B198(TDA_[7], TDA[7]);
  buf B199(TDA_[8], TDA[8]);
  buf B200(TDA_[9], TDA[9]);
  buf B201(TDA_[10], TDA[10]);
  buf B202(TDA_[11], TDA[11]);
  buf B203(TDA_[12], TDA[12]);
  buf B204(TDA_[13], TDA[13]);
  buf B205(TDA_[14], TDA[14]);
  buf B206(TDA_[15], TDA[15]);
  buf B207(TDA_[16], TDA[16]);
  buf B208(TDA_[17], TDA[17]);
  buf B209(TDA_[18], TDA[18]);
  buf B210(TDA_[19], TDA[19]);
  buf B211(TQA_[0], TQA[0]);
  buf B212(TQA_[1], TQA[1]);
  buf B213(TQA_[2], TQA[2]);
  buf B214(TQA_[3], TQA[3]);
  buf B215(TQA_[4], TQA[4]);
  buf B216(TQA_[5], TQA[5]);
  buf B217(TQA_[6], TQA[6]);
  buf B218(TQA_[7], TQA[7]);
  buf B219(TQA_[8], TQA[8]);
  buf B220(TQA_[9], TQA[9]);
  buf B221(TQA_[10], TQA[10]);
  buf B222(TQA_[11], TQA[11]);
  buf B223(TQA_[12], TQA[12]);
  buf B224(TQA_[13], TQA[13]);
  buf B225(TQA_[14], TQA[14]);
  buf B226(TQA_[15], TQA[15]);
  buf B227(TQA_[16], TQA[16]);
  buf B228(TQA_[17], TQA[17]);
  buf B229(TQA_[18], TQA[18]);
  buf B230(TQA_[19], TQA[19]);
  buf B231(TENB_, TENB);
  buf B232(BENB_, BENB);
  buf B233(TCENB_, TCENB);
  buf B234(TWENB_, TWENB);
  buf B235(TAB_[0], TAB[0]);
  buf B236(TAB_[1], TAB[1]);
  buf B237(TAB_[2], TAB[2]);
  buf B238(TAB_[3], TAB[3]);
  buf B239(TAB_[4], TAB[4]);
  buf B240(TAB_[5], TAB[5]);
  buf B241(TAB_[6], TAB[6]);
  buf B242(TAB_[7], TAB[7]);
  buf B243(TAB_[8], TAB[8]);
  buf B244(TDB_[0], TDB[0]);
  buf B245(TDB_[1], TDB[1]);
  buf B246(TDB_[2], TDB[2]);
  buf B247(TDB_[3], TDB[3]);
  buf B248(TDB_[4], TDB[4]);
  buf B249(TDB_[5], TDB[5]);
  buf B250(TDB_[6], TDB[6]);
  buf B251(TDB_[7], TDB[7]);
  buf B252(TDB_[8], TDB[8]);
  buf B253(TDB_[9], TDB[9]);
  buf B254(TDB_[10], TDB[10]);
  buf B255(TDB_[11], TDB[11]);
  buf B256(TDB_[12], TDB[12]);
  buf B257(TDB_[13], TDB[13]);
  buf B258(TDB_[14], TDB[14]);
  buf B259(TDB_[15], TDB[15]);
  buf B260(TDB_[16], TDB[16]);
  buf B261(TDB_[17], TDB[17]);
  buf B262(TDB_[18], TDB[18]);
  buf B263(TDB_[19], TDB[19]);
  buf B264(TQB_[0], TQB[0]);
  buf B265(TQB_[1], TQB[1]);
  buf B266(TQB_[2], TQB[2]);
  buf B267(TQB_[3], TQB[3]);
  buf B268(TQB_[4], TQB[4]);
  buf B269(TQB_[5], TQB[5]);
  buf B270(TQB_[6], TQB[6]);
  buf B271(TQB_[7], TQB[7]);
  buf B272(TQB_[8], TQB[8]);
  buf B273(TQB_[9], TQB[9]);
  buf B274(TQB_[10], TQB[10]);
  buf B275(TQB_[11], TQB[11]);
  buf B276(TQB_[12], TQB[12]);
  buf B277(TQB_[13], TQB[13]);
  buf B278(TQB_[14], TQB[14]);
  buf B279(TQB_[15], TQB[15]);
  buf B280(TQB_[16], TQB[16]);
  buf B281(TQB_[17], TQB[17]);
  buf B282(TQB_[18], TQB[18]);
  buf B283(TQB_[19], TQB[19]);
  buf B284(RET1N_, RET1N);
  buf B285(STOVA_, STOVA);
  buf B286(STOVB_, STOVB);
  buf B287(COLLDISN_, COLLDISN);
  ...
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {20{1'bx}};
   `ifdef ARM_FAULT_MODELING
     sram_dp_point_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .WEN(WENA_int), .Q_in(QA_int));
  `else
...
`endif
`timescale 1ns/1ps
module sram_dp_point_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, BEN, TQ);
   output [19:0] Q_out;
   input [19:0] Q_in;
   input CLK;
   input [8:0] A;
