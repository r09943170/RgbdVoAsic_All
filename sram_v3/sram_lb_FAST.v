...
//       
//       Creation Date:  Sun May 21 10:25:52 2023
//       Version: 	r5p0
//
...
`ifdef POWER_PINS
module sram_lb_FAST (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB,
...
`else
module sram_lb_FAST (CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB, QA, QB, CLKA,
...
`endif
  ...
  reg [23:0] QB_int;
  reg [23:0] QB_int_delayed;
  reg [23:0] writeEnable;
  real previous_CLKA;
  real previous_CLKB;
  ...
  reg NOT_AA2, NOT_AA1, NOT_AA0, NOT_DA23, NOT_DA22, NOT_DA21, NOT_DA20, NOT_DA19;
  ...
  reg NOT_AB4, NOT_AB3, NOT_AB2, NOT_AB1, NOT_AB0, NOT_DB23, NOT_DB22, NOT_DB21, NOT_DB20;
  ...
  reg NOT_EMASA, NOT_EMAB2, NOT_EMAB1, NOT_EMAB0, NOT_EMAWB1, NOT_EMAWB0, NOT_EMASB;
  reg NOT_TENA, NOT_TCENA, NOT_TWENA, NOT_TAA9, NOT_TAA8, NOT_TAA7, NOT_TAA6, NOT_TAA5;
  reg NOT_TAA4, NOT_TAA3, NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TDA23, NOT_TDA22, NOT_TDA21;
  reg NOT_TDA20, NOT_TDA19, NOT_TDA18, NOT_TDA17, NOT_TDA16, NOT_TDA15, NOT_TDA14;
  reg NOT_TDA13, NOT_TDA12, NOT_TDA11, NOT_TDA10, NOT_TDA9, NOT_TDA8, NOT_TDA7, NOT_TDA6;
  ...
  reg NOT_TAB2, NOT_TAB1, NOT_TAB0, NOT_TDB23, NOT_TDB22, NOT_TDB21, NOT_TDB20, NOT_TDB19;
 ...
 wire  CLKB_;
  ...
  assign `ARM_UD_DP DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {24{1'bx}};
  ...
  assign `ARM_UD_DP DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {24{1'bx}};
  assign `ARM_UD_SEQ QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {24{1'bx}};
  assign `ARM_UD_SEQ QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {24{1'bx}};
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENA_int)} === 1'bx) begin
      ...
      QA_int = WENA_int !== 1'b1 ? QA_int : {24{1'bx}};
      QA_int_delayed = WENA_int !== 1'b1 ? QA_int_delayed : {24{1'bx}};
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENB_int)} === 1'bx) begin
      ...
      QB_int = WENB_int !== 1'b1 ? QB_int : {24{1'bx}};
      QB_int_delayed = WENB_int !== 1'b1 ? QB_int_delayed : {24{1'bx}};
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B36(CENYB, CENYB_);
  buf B37(WENYB, WENYB_);
  buf B38(AYB[0], AYB_[0]);
  buf B39(AYB[1], AYB_[1]);
  buf B40(AYB[2], AYB_[2]);
  buf B41(AYB[3], AYB_[3]);
  buf B42(AYB[4], AYB_[4]);
  buf B43(AYB[5], AYB_[5]);
  buf B44(AYB[6], AYB_[6]);
  buf B45(AYB[7], AYB_[7]);
  buf B46(AYB[8], AYB_[8]);
  buf B47(AYB[9], AYB_[9]);
  buf B48(DYB[0], DYB_[0]);
  buf B49(DYB[1], DYB_[1]);
  buf B50(DYB[2], DYB_[2]);
  buf B51(DYB[3], DYB_[3]);
  buf B52(DYB[4], DYB_[4]);
  buf B53(DYB[5], DYB_[5]);
  buf B54(DYB[6], DYB_[6]);
  buf B55(DYB[7], DYB_[7]);
  buf B56(DYB[8], DYB_[8]);
  buf B57(DYB[9], DYB_[9]);
  buf B58(DYB[10], DYB_[10]);
  buf B59(DYB[11], DYB_[11]);
  buf B60(DYB[12], DYB_[12]);
  buf B61(DYB[13], DYB_[13]);
  buf B62(DYB[14], DYB_[14]);
  buf B63(DYB[15], DYB_[15]);
  buf B64(DYB[16], DYB_[16]);
  buf B65(DYB[17], DYB_[17]);
  buf B66(DYB[18], DYB_[18]);
  buf B67(DYB[19], DYB_[19]);
  buf B68(DYB[20], DYB_[20]);
  buf B69(DYB[21], DYB_[21]);
  buf B70(DYB[22], DYB_[22]);
  buf B71(DYB[23], DYB_[23]);
  buf B72(QA[0], QA_[0]);
  buf B73(QA[1], QA_[1]);
  buf B74(QA[2], QA_[2]);
  buf B75(QA[3], QA_[3]);
  ...
  buf B80(QA[8], QA_[8]);
  buf B81(QA[9], QA_[9]);
  buf B82(QA[10], QA_[10]);
  buf B83(QA[11], QA_[11]);
  buf B84(QA[12], QA_[12]);
  buf B85(QA[13], QA_[13]);
  buf B86(QA[14], QA_[14]);
  buf B87(QA[15], QA_[15]);
  buf B88(QA[16], QA_[16]);
  buf B89(QA[17], QA_[17]);
  buf B90(QA[18], QA_[18]);
  buf B91(QA[19], QA_[19]);
  buf B92(QA[20], QA_[20]);
  buf B93(QA[21], QA_[21]);
  buf B94(QA[22], QA_[22]);
  buf B95(QA[23], QA_[23]);
  buf B96(QB[0], QB_[0]);
  buf B97(QB[1], QB_[1]);
  buf B98(QB[2], QB_[2]);
  buf B99(QB[3], QB_[3]);
  ...
  buf B104(QB[8], QB_[8]);
  buf B105(QB[9], QB_[9]);
  buf B106(QB[10], QB_[10]);
  buf B107(QB[11], QB_[11]);
  buf B108(QB[12], QB_[12]);
  buf B109(QB[13], QB_[13]);
  buf B110(QB[14], QB_[14]);
  buf B111(QB[15], QB_[15]);
  buf B112(QB[16], QB_[16]);
  buf B113(QB[17], QB_[17]);
  buf B114(QB[18], QB_[18]);
  buf B115(QB[19], QB_[19]);
  buf B116(QB[20], QB_[20]);
  buf B117(QB[21], QB_[21]);
  buf B118(QB[22], QB_[22]);
  buf B119(QB[23], QB_[23]);
  buf B120(CLKA_, CLKA);
  buf B121(CENA_, CENA);
  buf B122(WENA_, WENA);
  buf B123(AA_[0], AA[0]);
  ...
  buf B141(DA_[8], DA[8]);
  buf B142(DA_[9], DA[9]);
  buf B143(DA_[10], DA[10]);
  buf B144(DA_[11], DA[11]);
  buf B145(DA_[12], DA[12]);
  buf B146(DA_[13], DA[13]);
  buf B147(DA_[14], DA[14]);
  buf B148(DA_[15], DA[15]);
  buf B149(DA_[16], DA[16]);
  buf B150(DA_[17], DA[17]);
  buf B151(DA_[18], DA[18]);
  buf B152(DA_[19], DA[19]);
  buf B153(DA_[20], DA[20]);
  buf B154(DA_[21], DA[21]);
  buf B155(DA_[22], DA[22]);
  buf B156(DA_[23], DA[23]);
  buf B157(CLKB_, CLKB);
  buf B158(CENB_, CENB);
  buf B159(WENB_, WENB);
  buf B160(AB_[0], AB[0]);
  ...
  buf B194(EMAA_[0], EMAA[0]);
  buf B195(EMAA_[1], EMAA[1]);
  buf B196(EMAA_[2], EMAA[2]);
  buf B197(EMAWA_[0], EMAWA[0]);
  buf B198(EMAWA_[1], EMAWA[1]);
  buf B199(EMASA_, EMASA);
  buf B200(EMAB_[0], EMAB[0]);
  buf B201(EMAB_[1], EMAB[1]);
  buf B202(EMAB_[2], EMAB[2]);
  buf B203(EMAWB_[0], EMAWB[0]);
  buf B204(EMAWB_[1], EMAWB[1]);
  buf B205(EMASB_, EMASB);
  buf B206(TENA_, TENA);
  buf B207(BENA_, BENA);
  buf B208(TCENA_, TCENA);
  buf B209(TWENA_, TWENA);
  buf B210(TAA_[0], TAA[0]);
  buf B211(TAA_[1], TAA[1]);
  buf B212(TAA_[2], TAA[2]);
  buf B213(TAA_[3], TAA[3]);
  buf B214(TAA_[4], TAA[4]);
  buf B215(TAA_[5], TAA[5]);
  buf B216(TAA_[6], TAA[6]);
  buf B217(TAA_[7], TAA[7]);
  buf B218(TAA_[8], TAA[8]);
  buf B219(TAA_[9], TAA[9]);
  buf B220(TDA_[0], TDA[0]);
  buf B221(TDA_[1], TDA[1]);
  buf B222(TDA_[2], TDA[2]);
  buf B223(TDA_[3], TDA[3]);
  buf B224(TDA_[4], TDA[4]);
  buf B225(TDA_[5], TDA[5]);
  buf B226(TDA_[6], TDA[6]);
  buf B227(TDA_[7], TDA[7]);
  buf B228(TDA_[8], TDA[8]);
  buf B229(TDA_[9], TDA[9]);
  buf B230(TDA_[10], TDA[10]);
  buf B231(TDA_[11], TDA[11]);
  buf B232(TDA_[12], TDA[12]);
  buf B233(TDA_[13], TDA[13]);
  buf B234(TDA_[14], TDA[14]);
  buf B235(TDA_[15], TDA[15]);
  buf B236(TDA_[16], TDA[16]);
  buf B237(TDA_[17], TDA[17]);
  buf B238(TDA_[18], TDA[18]);
  buf B239(TDA_[19], TDA[19]);
  buf B240(TDA_[20], TDA[20]);
  buf B241(TDA_[21], TDA[21]);
  buf B242(TDA_[22], TDA[22]);
  buf B243(TDA_[23], TDA[23]);
  buf B244(TQA_[0], TQA[0]);
  buf B245(TQA_[1], TQA[1]);
  buf B246(TQA_[2], TQA[2]);
  buf B247(TQA_[3], TQA[3]);
  buf B248(TQA_[4], TQA[4]);
  buf B249(TQA_[5], TQA[5]);
  buf B250(TQA_[6], TQA[6]);
  buf B251(TQA_[7], TQA[7]);
  buf B252(TQA_[8], TQA[8]);
  buf B253(TQA_[9], TQA[9]);
  buf B254(TQA_[10], TQA[10]);
  buf B255(TQA_[11], TQA[11]);
  buf B256(TQA_[12], TQA[12]);
  buf B257(TQA_[13], TQA[13]);
  buf B258(TQA_[14], TQA[14]);
  buf B259(TQA_[15], TQA[15]);
  buf B260(TQA_[16], TQA[16]);
  buf B261(TQA_[17], TQA[17]);
  buf B262(TQA_[18], TQA[18]);
  buf B263(TQA_[19], TQA[19]);
  buf B264(TQA_[20], TQA[20]);
  buf B265(TQA_[21], TQA[21]);
  buf B266(TQA_[22], TQA[22]);
  buf B267(TQA_[23], TQA[23]);
  buf B268(TENB_, TENB);
  buf B269(BENB_, BENB);
  buf B270(TCENB_, TCENB);
  buf B271(TWENB_, TWENB);
  buf B272(TAB_[0], TAB[0]);
  buf B273(TAB_[1], TAB[1]);
  buf B274(TAB_[2], TAB[2]);
  buf B275(TAB_[3], TAB[3]);
  buf B276(TAB_[4], TAB[4]);
  buf B277(TAB_[5], TAB[5]);
  buf B278(TAB_[6], TAB[6]);
  buf B279(TAB_[7], TAB[7]);
  buf B280(TAB_[8], TAB[8]);
  buf B281(TAB_[9], TAB[9]);
  buf B282(TDB_[0], TDB[0]);
  buf B283(TDB_[1], TDB[1]);
  buf B284(TDB_[2], TDB[2]);
  buf B285(TDB_[3], TDB[3]);
  buf B286(TDB_[4], TDB[4]);
  buf B287(TDB_[5], TDB[5]);
  buf B288(TDB_[6], TDB[6]);
  buf B289(TDB_[7], TDB[7]);
  buf B290(TDB_[8], TDB[8]);
  buf B291(TDB_[9], TDB[9]);
  buf B292(TDB_[10], TDB[10]);
  buf B293(TDB_[11], TDB[11]);
  buf B294(TDB_[12], TDB[12]);
  buf B295(TDB_[13], TDB[13]);
  buf B296(TDB_[14], TDB[14]);
  buf B297(TDB_[15], TDB[15]);
  buf B298(TDB_[16], TDB[16]);
  buf B299(TDB_[17], TDB[17]);
  buf B300(TDB_[18], TDB[18]);
  buf B301(TDB_[19], TDB[19]);
  buf B302(TDB_[20], TDB[20]);
  buf B303(TDB_[21], TDB[21]);
  buf B304(TDB_[22], TDB[22]);
  buf B305(TDB_[23], TDB[23]);
  buf B306(TQB_[0], TQB[0]);
  buf B307(TQB_[1], TQB[1]);
  buf B308(TQB_[2], TQB[2]);
  buf B309(TQB_[3], TQB[3]);
  buf B310(TQB_[4], TQB[4]);
  buf B311(TQB_[5], TQB[5]);
  buf B312(TQB_[6], TQB[6]);
  buf B313(TQB_[7], TQB[7]);
  buf B314(TQB_[8], TQB[8]);
  buf B315(TQB_[9], TQB[9]);
  buf B316(TQB_[10], TQB[10]);
  buf B317(TQB_[11], TQB[11]);
  buf B318(TQB_[12], TQB[12]);
  buf B319(TQB_[13], TQB[13]);
  buf B320(TQB_[14], TQB[14]);
  buf B321(TQB_[15], TQB[15]);
  buf B322(TQB_[16], TQB[16]);
  buf B323(TQB_[17], TQB[17]);
  buf B324(TQB_[18], TQB[18]);
  buf B325(TQB_[19], TQB[19]);
  buf B326(TQB_[20], TQB[20]);
  buf B327(TQB_[21], TQB[21]);
  buf B328(TQB_[22], TQB[22]);
  buf B329(TQB_[23], TQB[23]);
  buf B330(RET1N_, RET1N);
  buf B331(STOVA_, STOVA);
  buf B332(STOVB_, STOVB);
  buf B333(COLLDISN_, COLLDISN);
  ...
  assign DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {24{1'bx}};
  ...
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {24{1'bx}};
   `ifdef ARM_FAULT_MODELING
     sram_lb_FAST_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .WEN(WENA_int), .Q_in(QA_int));
  `else
  assign QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {24{1'bx}};
  `endif
  assign QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {24{1'bx}};
...
`endif
`timescale 1ns/1ps
module sram_lb_FAST_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, BEN, TQ);
   output [23:0] Q_out;
   input [23:0] Q_in;
   input CLK;
   input [9:0] A;
